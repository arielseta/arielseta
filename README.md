...
Possuo perfil híbrido, combinando desenvolvimento, liderança técnica e gestão de projetos, com forte capacidade de adaptação entre tecnologias modernas e sistemas legados.

Também mantenho evolução contínua em Ciência de Dados e Machine Learning, ampliando minha capacidade de desenvolver soluções orientadas a dados e apoiar decisões estratégicas.

Tenho publicações acadêmicas nas áreas de IoT, saúde, educação e tecnologia aplicada, refletindo meu compromisso com inovação e geração de impacto real.

Estou aberto a oportunidades que envolvam tecnologia, liderança, modernização de sistemas e projetos estratégicos, assim como iniciativas ligadas à educação e formação tecnológica.
